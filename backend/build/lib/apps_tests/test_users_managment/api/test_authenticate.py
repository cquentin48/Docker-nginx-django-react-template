...
class UserManagmentTokenObtainPairViewTestCase(TestCase):
    ...
    def test_post_request_success(self):
        ...
        self.assertEqual(str(data['exp']),token.expires_at.strftime("%s"))
        ...
        self.assertEqual(str(data['registrationDate']), user.registration_date.strftime("%s"))
        self.assertEqual(str(data['lastLoginDate']), user.last_login.strftime("%s"))
