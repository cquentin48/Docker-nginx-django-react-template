...
class LogoutSerializerTestCase(TestCase):
    ...
    def test_fetch_token_success(self):
        ...
        self.assertEqual(operation_result.issued_at,datetime.datetime(1970,1,1,0,0,1,tzinfo=datetime.timezone.utc))
        self.assertEqual(operation_result.expires_at,datetime.datetime(1970,1,1,0,0,1,tzinfo=datetime.timezone.utc))
